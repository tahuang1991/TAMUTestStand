...
const int PULSE_IN_COMMANDS[] =
    {
     CCB_VME_BC0, // 0x52; CCB11;
     CCB_VME_L1ACC, // 0x54; CCB12
     CCB_VME_TMB_SOFT_RESET, // 0x6C; // TMB; CCB29
     CCB_VME_CLCT_EXT_TRIGGER, // 0x86; CCB32
     CCB_VME_ALCT_EXT_TRIGGER, // 0x88; CCB33
     CCB_VME_DMB_CFEB_CALIB0, // 0x8A; CCB39
     CCB_VME_DMB_CFEB_CALIB1, // 0x8C; CCB40
     CCB_VME_DMB_CFEB_CALIB2,  // 0x8E; CCB41
     CCB_VME_ALCT_HARD_RESET, // 0x66; CCB27
     CCB_VME_ALCT_ADB_PULSE_SYNC, // 0x82; CCB30
     CCB_VME_ALCT_ADB_PULSE_ASYNC, // 0x84; CCB31
     CCB_VME_TMB_RESERVED0 // CCB28
    };
const int LENGTH_PULSE_IN_COMMANDS = sizeof(PULSE_IN_COMMANDS)/sizeof(PULSE_IN_COMMANDS[0]);

// CCB_RX number corresponding to PULSE_IN_COMMANDS
// Maintained in parallel with PULSE_IN_COMMANDS
const int PULSE_IN_COMMANDS_CCB_N[] = {11,12,29,32,33,39,40,41,27,30,31,28};
